            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col gap-5">
                        <el-table :data="wks" style="width: 100%">
                            ...
                            <el-table-column label="Операции" align="center">
                                <template #default="scope">
                                    ...
                                    <el-button size="small" @click="changePublish(scope.row)">
                                        <svg v-if="scope.row.publish" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
